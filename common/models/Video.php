...
class Video extends \yii\db\ActiveRecord
{
    ...
    public function save($runValidation = true, $attributeNames = null)
    {
        ...
        if ($this->thumbnail) $this->has_thumbnail = 1;
        ...
        if ($isInsert) {
            ...
            if (!is_dir(dirname($videoPath))) FileHelper::createDirectory(dirname($videoPath));
            $this->video->saveAs($videoPath);
        }
        if ($this->thumbnail) {
            $thumbnailPath = Yii::getAlias('@frontend/web/storage/thumbs/' . $this->video_id . '.jpg');
            if (!is_dir(dirname($thumbnailPath))) FileHelper::createDirectory(dirname($thumbnailPath));
