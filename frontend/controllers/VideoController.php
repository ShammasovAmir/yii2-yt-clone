...
class VideoController extends Controller
{
    ...
    protected function findVideo($id)
    {
        ...
        if (!$video) throw new NotFoundHttpException("Video does not exist");
...
//    protected function manageLikeDislikeEvent($id, $actionType) {
//        $video = $this->findVideo($id);
//        $userId = \Yii::$app->user->id;
//
//        $videoLikeDislike = VideoLike::find()->userIdVideoId($userId, $id)->one();
//
//        if (!$videoLikeDislike)
//            $this->saveLikeDislike($id, $userId, $actionType);
//        else if ($videoLikeDislike->type == $actionType)
//            $videoLikeDislike->delete();
//        else {
//            $videoLikeDislike->delete();
//            $this->saveLikeDislike($id, $userId, $actionType);
